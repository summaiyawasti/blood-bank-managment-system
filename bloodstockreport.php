...
<div class="box"></div>
	<div class="box2"></div>
<h1 style="margin-top:10px;">&nbsp;&nbsp;&nbsp;Blood Stock Report</h1>
<table>
<tr>
    <th>Serial Number</th>
    <th>No of Units</th>
...
$conn = mysqli_connect("127.0.0.1", "root", "", "bdms");
  ...
  $sql = "SELECT bloodId,noOfUnits,bloodGroup,description FROM createbloodstock";
  ...
  if ($result->num_rows > 0) 
{
   ...
   {
    echo "<tr><td>" . $row["bloodId"]. "</td><td>" . $row["noOfUnits"] . "</td><td>". $row["bloodGroup"]. "</td><td>". $row["description"]."</td></tr>";
   }
      echo "</table>";
} 
else 
