...
<body>
<form method="post" action="bloodsells.php">
...
<div class="box"></div>
	<div class="box2"></div>
<h1 style="margin-top:10px;">&nbsp;&nbsp;&nbsp;Blood Sells</h1>
<table>
<tr>
    <th>Customer Name</th>
    <th>Blood Group</th> 
    <th>No of Units</th>
    <th>Refer Hospital</th>
</tr>
<?php
$conn = mysqli_connect("127.0.0.1", "root", "", "bdms");
  ...
  $sql = "SELECT bloodSellId,bloodGroup,noOfUnits,customerName,contactNumber,hospital,address FROM createbloodsells";
  ...
  if ($result->num_rows > 0) 
{
   ...
   {
    echo "<tr><td>" . $row["customerName"]. "</td><td>" . $row["bloodGroup"] . "</td><td>". $row["noOfUnits"]. "</td><td>" . $row["hospital"] . "</td></tr>";
   }
      echo "</table>";
} 
else 
